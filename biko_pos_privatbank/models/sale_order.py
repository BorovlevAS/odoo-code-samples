...
class SaleOrder(models.Model):
    ...
    def _get_payment_terminal_data(
        ...
        """
        Retrieve payment terminal data for a given payment type and POS session.
        This method extends the base implementation to include additional data
        from the PrivatBank terminal transaction, if available.
        Args:
        ...
        Returns:
            Dict[str, Any]: A dictionary containing payment terminal data, including
            card mask, bank name, authorization code, RRN, payment system, terminal ID,
            and receipt number, if available.
        """
